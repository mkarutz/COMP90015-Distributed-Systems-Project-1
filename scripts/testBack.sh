...
sleep 2
gnome-terminal -t server1 -e "java -jar build/libs/Server.jar -rh localhost -rp 4001 -d -lp 4010 -slp 4011 -secure"
sleep 2
gnome-terminal -t server2 -e "java -jar build/libs/Server.jar -rh localhost -rp 4001 -d -lp 4020 -slp 4021 -secure"
sleep 2
